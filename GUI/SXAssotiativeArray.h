#ifndef SX_SXAssotiativeArray_H
#define SX_SXAssotiativeArray_H
//#include "DSbase.h"
...
class SXAssotiativeArray
{
	...
	SXMemAlloc<Node> MemNodes;
	SXMemAlloc<SX_VALTYPE> MemVals;
...
*/
	...
	SXAssotiativeArray():RootNode(NULL), Size_(0)
	{
		//printf("SXAssotiativeArray()\n");
	}
	SXAssotiativeArray(const SXAssotiativeArray & a)
	{
		DS_ASSERT(false);
		this->Size_ = a.Size_;
	...
	SXAssotiativeArray & operator=(const SXAssotiativeArray & a)
	{
		for(SXAssotiativeArray<SX_KEYTYPE, SX_VALTYPE>::Iterator i = a.begin(); i; i++)
		{
