...
/******************************************************
Copyright й Vitaliy Buturlin, Evgeny Danilovich, 2017
...
#include <SXGUIWinApi\SXGUI_toolbar_sx.cpp>
...
ISXGUIToolBarSX* SXGUICrToolBarSXEx(const char* caption, WORD x, WORD y, WORD width, WORD heigth, HWND parent, WNDPROC handler, DWORD id, const char* path_button_ctrl, DWORD id_ctrl_button)
{
	return new SXGUIToolBarSX(caption, x, y, width, heigth, parent, handler, id, path_button_ctrl, id_ctrl_button);
}

ISXGUIToolBarSX* SXGUICrToolBarSX(const char* caption, WORD x, WORD y, WORD width, WORD heigth, HWND parent, WNDPROC handler, DWORD id, WORD button_res, DWORD id_ctrl_button)
{
	return new SXGUIToolBarSX(caption, x, y, width, heigth, parent, handler, id, button_res, id_ctrl_button);
}
