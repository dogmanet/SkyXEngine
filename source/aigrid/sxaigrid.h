...
AI сетка состоит из квадратов (сокр. квад), квады имеют соседей (приелгающие квады по xz), некоторые квады могут быть графпонитами\n
...
SX_LIB_API void SAIG_BBGePos(float3* pos);					//!< записывает позицию ббокса
...
SX_LIB_API bool SAIG_QuadIsFree(ID id, int radius);				//!< свободен ли квад id в радиусе radius (radius - количество квадов вокруг указанного в id, 1 - значит только указанный, 2 - значит все соседние и т.д.)
