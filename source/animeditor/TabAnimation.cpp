...
TabAnimation::TabAnimation(TabManager * tm):EditorTab(tm)
{
	...
	AnimCtlProgress = SXGUICrEdit("Progress", 65, 15, 100, 20, AnimCtlGB->GetHWND(), 0, 0);
	...
	AnimCtlPlayBtn = SXGUICrButton("Play", 178, 15, 61, 20, 0, AnimCtlGB->GetHWND(), 0, 0);
	AnimCtlPlayBtn->SetFont("MS Shell Dlg", -11, 0, 400, 0, 0, 0);
	AnimCtlPlayBtn->GAlign = {1, 1, 0, 0};
	AnimCtlPauseBtn = SXGUICrButton("Pause", 240, 15, 59, 20, 0, AnimCtlGB->GetHWND(), 0, 0);
	AnimCtlPauseBtn->SetFont("MS Shell Dlg", -11, 0, 400, 0, 0, 0);
	AnimCtlPauseBtn->GAlign = {1, 1, 0, 0};
	AnimCtlProgressTrack = SXGUICrTrackBar("", 6, 43, 489, 20, AnimCtlGB->GetHWND(), 0, 0);
	...
	AnimPropLoopCB = SXGUICrCheckBox("Loop animation", 10, 88, 100, 20, AnimPropsGB->GetHWND(), 0, 0, false);
	...
	AnimPropSpeed = SXGUICrEdit("Speed", 54, 65, 229, 20, AnimPropsGB->GetHWND(), 0, 0);
	...
	AnimPropSpeedSpin = SXGUICrUpDown(283, 65, 17, 20, AnimPropsGB->GetHWND(), 0, 0, 0, 0);
	...
	AnimPropName = SXGUICrEdit("Name", 54, 19, 246, 20, AnimPropsGB->GetHWND(), 0, 0);
	...
	AnimPropActCmb = SXGUICrComboBox("", 54, 42, 123, 21, AnimPropsGB->GetHWND(), 0, 0);
	...
	AnimPropActChance = SXGUICrEdit("Chance", 229, 42, 71, 20, AnimPropsGB->GetHWND(), 0, 0);
