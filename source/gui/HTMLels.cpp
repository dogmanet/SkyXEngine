...
#include "IRADIO.h"
#include "IRANGE.h"
#include "IRANGE_BAR.h"
#include "IRANGE_DRAG.h"
#include "IRANGE_METER.h"
#include "IRANGE_TEXT.h"
...
namespace gui
{
	namespace dom
	{
		void HTMLelsInit()
		{
			...
			LINK_DOM_NODE_TO_TAG(IRANGE_DRAG, L"range-drag");
			LINK_DOM_NODE_TO_TAG(IRANGE_METER, L"range-meter");
