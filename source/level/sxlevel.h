...
\note При смене погоды для некоторых параметров возможна интерполяция данных от прошлой погоды к текущей на основании игрового времени, поэтому #SXLevel_WeatherUpdate необходимо вызывать в основном цикле (в рендере) для планой смены
