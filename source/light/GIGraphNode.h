#ifndef __GIGRAPHNODE_H
#define __GIGRAPHNODE_H

#include <xcommon/render/IXRender.h>
#include <xcommon/IXCore.h>
#include "LightSystem.h"

class CGIGraphNodeData;
class CGIGraphNode final: public IXUnknownImplementation<IXRenderGraphNode>
{
public:
	CGIGraphNode(IXCore *pCore, CLightSystem *pLightSystem);
	~CGIGraphNode();
