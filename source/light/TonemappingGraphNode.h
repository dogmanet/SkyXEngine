#ifndef __TONEMAPPINGGRAPHNODE_H
#define __TONEMAPPINGGRAPHNODE_H

#include <xcommon/render/IXRender.h>
#include <xcommon/IXCore.h>
#include "LightSystem.h"

class CTonemappingGraphNodeData;
class CTonemappingGraphNode final: public IXUnknownImplementation<IXRenderGraphNode>
{
public:
	CTonemappingGraphNode(IXCore *pCore, CLightSystem *pLightSystem);
	~CTonemappingGraphNode();
