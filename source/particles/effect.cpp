...
bool CEffects::effectVisibleCom(ID id, const IXFrustum* frustum, const float3* view)
{
...
void CEffects::effectVisibleComAll(const IXFrustum* frustum, const float3* view)
{
