#ifndef __FXAAGRAPHNODE_H
#define __FXAAGRAPHNODE_H

#include <xcommon/render/IXRender.h>
#include <xcommon/IXCore.h>

class CFXAAGraphNodeData;
class CFXAAGraphNode final: public IXUnknownImplementation<IXRenderGraphNode>
{
public:
	CFXAAGraphNode(IXCore *pCore);
	~CFXAAGraphNode();
