#ifndef __SCENEFINALGRAPHNODE_H
#define __SCENEFINALGRAPHNODE_H

#include <xcommon/render/IXRender.h>
#include <xcommon/IXCore.h>

class CSceneFinalGraphNodeData;
class CSceneFinalGraphNode final: public IXUnknownImplementation<IXRenderGraphNode>
{
public:
	CSceneFinalGraphNode(IXCore *pCore);
	~CSceneFinalGraphNode();
