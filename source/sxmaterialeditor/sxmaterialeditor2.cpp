...
namespace SXMaterialEditor
{
	...
	ISXGUIStatic* Static21;
	ISXGUICheckBox* CheckBoxBoxDoSPVS;
	ISXGUICheckBox* CheckBoxBoxDoSPPS;
...
void SXMaterialEditor::InitAllElements()
{
	...
	SXMaterialEditor::ToolBar = SXGUICrToolBar("",0,0,635,25,635,25,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	...
	SXMaterialEditor::ComboBoxTypeModel = SXGUICrComboBox("",100,347,200,21,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	...
	SXMaterialEditor::ComboBoxTestModel = SXGUICrComboBox("",100,370,200,21,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	...
	SXMaterialEditor::StaticMaD = SXGUICrStatic("Microrelief and detail",305,137,100,15,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	...
	SXMaterialEditor::CheckBoxTexLighting = SXGUICrCheckBox("texure:",305,90,60,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSVVS = SXGUICrCheckBox("vs",340,390,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::ComboBoxPhysic = SXGUICrComboBox("",100,462,200,21,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	...
	SXMaterialEditor::CheckBoxDoSWVS = SXGUICrCheckBox("vs",340,370,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSWPS = SXGUICrCheckBox("ps",373,370,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSVPS = SXGUICrCheckBox("ps",373,390,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::Static21 = SXGUICrStatic("P mat:",305,410,35,15,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	SXMaterialEditor::Static21->SetFont("MS Shell Dlg",-11,0,400,0,0,0);
	SXMaterialEditor::Static21->SetColorText(0,0,0);
	SXMaterialEditor::Static21->SetColorTextBk(255,255,255);
	SXMaterialEditor::Static21->SetTransparentTextBk(true);
	SXMaterialEditor::Static21->SetColorBrush(220,220,220);
	SXMaterialEditor::CheckBoxBoxDoSPVS = SXGUICrCheckBox("vs",340,410,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	SXMaterialEditor::CheckBoxBoxDoSPVS->SetFont("MS Shell Dlg",-11,0,400,0,0,0);
	SXMaterialEditor::CheckBoxBoxDoSPVS->SetColorText(0,0,0);
	SXMaterialEditor::CheckBoxBoxDoSPVS->SetColorTextBk(255,255,255);
	SXMaterialEditor::CheckBoxBoxDoSPVS->SetTransparentTextBk(true);
	SXMaterialEditor::CheckBoxBoxDoSPVS->SetColorBrush(220,220,220);
	SXMaterialEditor::CheckBoxBoxDoSPPS = SXGUICrCheckBox("ps",373,410,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	SXMaterialEditor::CheckBoxBoxDoSPPS->SetFont("MS Shell Dlg",-11,0,400,0,0,0);
	SXMaterialEditor::CheckBoxBoxDoSPPS->SetColorText(0,0,0);
	SXMaterialEditor::CheckBoxBoxDoSPPS->SetColorTextBk(255,255,255);
	SXMaterialEditor::CheckBoxBoxDoSPPS->SetTransparentTextBk(true);
	SXMaterialEditor::CheckBoxBoxDoSPPS->SetColorBrush(220,220,220);
	...
	SXMaterialEditor::CheckBoxDoSWVVS = SXGUICrCheckBox("vs",455,370,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSWVPS = SXGUICrCheckBox("ps",488,370,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSCamposVS = SXGUICrCheckBox("vs",455,410,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSWVPVS = SXGUICrCheckBox("vs",455,390,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSWVPPS = SXGUICrCheckBox("ps",488,390,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSCamposPS = SXGUICrCheckBox("ps",488,411,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::StaticUDVS = SXGUICrStatic("User data VS:",305,440,100,15,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	SXMaterialEditor::StaticUDVS->SetFont("MS Shell Dlg",-11,0,400,0,0,0);
	SXMaterialEditor::StaticUDVS->SetColorText(0,0,0);
	SXMaterialEditor::StaticUDVS->SetColorTextBk(255,255,255);
	SXMaterialEditor::StaticUDVS->SetTransparentTextBk(true);
	SXMaterialEditor::StaticUDVS->SetColorBrush(220,220,220);
	SXMaterialEditor::CheckBoxUDVSInPS = SXGUICrCheckBox("in PS",445,440,100,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::StaticUDVS_x = SXGUICrStatic("x:",305,460,15,15,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	SXMaterialEditor::StaticUDVS_x->SetFont("MS Shell Dlg",-11,0,400,0,0,0);
	SXMaterialEditor::StaticUDVS_x->SetColorText(0,0,0);
	SXMaterialEditor::StaticUDVS_x->SetColorTextBk(255,255,255);
	SXMaterialEditor::StaticUDVS_x->SetTransparentTextBk(true);
	SXMaterialEditor::StaticUDVS_x->SetColorBrush(220,220,220);
	...
	SXMaterialEditor::StaticDoSTimeDelta = SXGUICrStatic("timedelta:",525,370,45,15,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	...
	SXMaterialEditor::CheckBoxDoSTimeDeltaVS = SXGUICrCheckBox("vs",570,370,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSTimeDeltaPS = SXGUICrCheckBox("ps",603,370,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::StaticUDPS = SXGUICrStatic("User data PS:",305,550,100,15,SXMaterialEditor::JobWindow->GetHWND(),0,0);
	SXMaterialEditor::StaticUDPS->SetFont("MS Shell Dlg",-11,0,400,0,0,0);
	SXMaterialEditor::StaticUDPS->SetColorText(0,0,0);
	SXMaterialEditor::StaticUDPS->SetColorTextBk(255,255,255);
	SXMaterialEditor::StaticUDPS->SetTransparentTextBk(true);
	SXMaterialEditor::StaticUDPS->SetColorBrush(220,220,220);
	SXMaterialEditor::CheckBoxUDPSInVS = SXGUICrCheckBox("in VS",445,550,100,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSWinSizeVS = SXGUICrCheckBox("vs",570,390,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxDoSWinSizePS = SXGUICrCheckBox("ps",603,390,30,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
	...
	SXMaterialEditor::CheckBoxModelRot = SXGUICrCheckBox("rotate",5,330,50,15,SXMaterialEditor::JobWindow->GetHWND(),0,0,true);
...
void SXMaterialEditor::DeleteAllElements()
{
	...
	mem_delete(SXMaterialEditor::Static21);
	mem_delete(SXMaterialEditor::CheckBoxBoxDoSPVS);
	mem_delete(SXMaterialEditor::CheckBoxBoxDoSPPS);
	...
	mem_delete(SXMaterialEditor::StaticUDVS);
	...
	mem_delete(SXMaterialEditor::StaticUDVS_x);
	...
	mem_delete(SXMaterialEditor::StaticUDPS);
